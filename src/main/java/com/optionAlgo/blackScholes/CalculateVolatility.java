	...
	public static void main(String[] args) {
		...
		double tempOptPrice = 0;
			 ...
			 while(true){
				 ...
				 tempOptPrice = BlackScholesFormula.calculate(true, 10030, 10050, 10/100.0, 34.0/365, volatility/100);
			 ...
			 for(v = volatility -9 ; v < volatility ; v++){
				 ...
				 tempOptPrice = BlackScholesFormula.calculate(true, 10030, 10050, 10/100.0, 34.0/365,  v/100);
			 ...
			 for(i = v-0.9; i < v ; i=i+0.1){
				 tempOptPrice = BlackScholesFormula.calculate(true, 10030, 10050, 10/100.0, 34.0/365,  (i-5) /100);
				 if(actualOptPrice < tempOptPrice){
					 break;
				 }
			 }
